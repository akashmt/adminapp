...
function IconArrowAltCircleRight() {
	return (
		<svg id="icon-arrow-alt-circle-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
export default IconArrowAltCircleRight